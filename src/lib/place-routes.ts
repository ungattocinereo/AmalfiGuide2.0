...
export const routeAssets: RouteAsset[] = [
    ...
    },
    {
        ...
        staticPreview: {
            polyline: "}qbwFekjxAEHABUh@a@jA@b@AZCj@@TDRCf@A`@Kb@Ej@DXBRZp@BRHPDZCTW`@AREr@Kf@QrD|BvKNGBIFEFENAPETGLE@BVv@Nd@?PADCj@@d@BDcNyHJRZ^HBFL^NTBJHN\\Pd@Xh@VZVDTGPALQHIDG`@i@}BwKEHIJo@RYPOLU^g@v@Wj@GRGNAH~Hwg@[\\GFJlArElo@Wo@",
            start: [14.6400277, 40.6507074],
            end: [14.632468, 40.6497979],
        },
