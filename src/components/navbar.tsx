                ...
                <div className="flex items-center gap-2 sm:gap-3">
                    ...
                    <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end" className="rounded-2xl min-w-[180px] p-2 bg-white/70 dark:bg-black/70 backdrop-blur-2xl border border-white/30 dark:border-white/10 shadow-[0_16px_48px_rgba(0,0,0,0.2)] animate-in fade-in-0 zoom-in-95 slide-in-from-top-2 duration-200">
                            <DropdownMenuItem className="gap-3 cursor-pointer rounded-xl px-4 py-3 text-base font-medium hover:bg-white/50 dark:hover:bg-white/10 transition-all duration-150"><span className="text-xl">🇬🇧</span><span>English</span></DropdownMenuItem>
                            <DropdownMenuItem className="gap-3 cursor-pointer rounded-xl px-4 py-3 text-base font-medium hover:bg-white/50 dark:hover:bg-white/10 transition-all duration-150"><span className="text-xl">🇮🇹</span><span>Italiano</span></DropdownMenuItem>
                            <DropdownMenuItem className="gap-3 cursor-pointer rounded-xl px-4 py-3 text-base font-medium hover:bg-white/50 dark:hover:bg-white/10 transition-all duration-150"><span className="text-xl">🇪🇸</span><span>Español</span></DropdownMenuItem>
                            <DropdownMenuItem className="gap-3 cursor-pointer rounded-xl px-4 py-3 text-base font-medium hover:bg-white/50 dark:hover:bg-white/10 transition-all duration-150"><span className="text-xl">🇫🇷</span><span>Français</span></DropdownMenuItem>
                            <DropdownMenuItem className="gap-3 cursor-pointer rounded-xl px-4 py-3 text-base font-medium hover:bg-white/50 dark:hover:bg-white/10 transition-all duration-150"><span className="text-xl">🇩🇪</span><span>Deutsch</span></DropdownMenuItem>
                        </DropdownMenuContent>
                    </DropdownMenu>
